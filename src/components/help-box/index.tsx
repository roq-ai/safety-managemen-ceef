...
export const HelpBox: React.FC = () => {
  ...
  const tenantRoles: string[] = ['Safety Manager', 'Risk Analyst', 'Compliance Officer', 'Administrator'];
  const addOns: string[] = [];
  const applicationName = `Safety Management Systems`;
  const tenantName = `Airline`;
