...
import { getRiskAssessmentById } from 'apiSdk/risk-assessments';
...
function RiskAssessmentViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('risk_assessment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/risk-assessments/edit/${data?.id}`} passHref legacyBehavior>
              <Button
